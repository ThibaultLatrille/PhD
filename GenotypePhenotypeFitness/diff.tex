...
%DIF ADD main-revision.tex   Tue Jul 20 11:32:25 2021
...
\begin{equation}
    \ln \left( \frac{1 - x\eq}{x\eq} \right) + \ln (19) = 4\Ne y A \beta \EmpiricalDeltaDeltaG \DIFdelbegin %DIFDELCMD < \NbrSites %%%
\DIFdelend e\DIFdelbegin \DIFdel{^{\beta(\EmpiricalDeltaGmin + \EmpiricalDeltaDeltaG \NbrSites x\eq)}}\DIFdelend \DIFaddbegin \DIFadd{^{\beta(\EmpiricalDeltaGmin + \NbrSites \EmpiricalDeltaDeltaG x\eq)}}\DIFaddend .
\end{equation}
