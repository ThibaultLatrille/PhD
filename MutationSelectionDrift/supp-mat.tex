...
\begin{document}
	...
	\lstinputlisting[breaklines]{placnr.lht.rootedtree.nhx}
	...
	\begin{table}[H]
		...
		\noindent\adjustbox{max width=\textwidth}{%
			\begin{tabu}{|c|c|}
				...
				\hline
				Mutation rate (at the root) & $u=1.0 \times 10^{-8}$ per site per generation\\ \hline
				Root age & $150$ Million years \\ \hline
				Generation time (at the root) & $\tau=10$ years \\ \hline
				Effective population size (at the root) & $\Ne=1.0$ (for identifiability of fitness profiles) \\ \hline
				Number of codon sites & $5,000$\\ \hline
				Exon size (number of codon sites) & $300$\\ \hline
				Random seed & $65489$\\ \hline
				Branch-wise correlation & True \\ \hline
			\end{tabu}}
	...
	% 340 × 1021 mm
	\includepdf[pages=1,trim=0mm 510.5mm 0mm 0mm, clip, width=\textwidth]{simulations/Profiles_SimuDiv}
	\includepdf[pages=1,trim=0mm 0mm 0mm 510.5mm, clip, width=\textwidth]{simulations/Profiles_SimuDiv}
	...
	\includepdf[pages=1,trim=0mm 510.5mm 0mm 0mm, clip, width=\textwidth]{simulations/Profiles_SimuDiv_Estimated}
	\includepdf[pages=1,trim=0mm 0mm 0mm 510.5mm, clip, width=\textwidth]{simulations/Profiles_SimuDiv_Estimated}
	...
	\begin{table}[H]
		...
		\noindent\adjustbox{max width=\textwidth}{%
			\begin{tabu}{|c|c|}
				...
				Exon size (number of codon sites) & $300$\\ \hline
				Random seed & $65489$\\ \hline
				Effective population size (at the root) & $\Ne = 5,000$ \\ \hline
				$\sigma$ parameter for Ornstein-Uhlenbeck process & $0.2$ \\ \hline
				$\theta$ parameter for Ornstein-Uhlenbeck process & $0.2$ \\ \hline
			\end{tabu}}
		\caption[Parameters used for \texttt{SimuPoly}]{
			Parameters used for \texttt{SimuPoly}.
			The configuration files and scripts to produce simulations are available as \texttt{config.yaml} at \url{https://github.com/ThibaultLatrille/MutationSelectionDrift}.
		}
	\end{table}
	...
	% 340 × 1021 mm
	\includepdf[pages=1,trim=0mm 510.5mm 0mm 0mm, clip, width=\textwidth]{simulations/Profiles_SimuPoly}
	\includepdf[pages=1,trim=0mm 0mm 0mm 510.5mm, clip, width=\textwidth]{simulations/Profiles_SimuPoly}
	...
	\includepdf[pages=1,trim=0mm 510.5mm 0mm 0mm, clip, width=\textwidth]{simulations/Profiles_SimuPoly_Estimated}
	\includepdf[pages=1,trim=0mm 0mm 0mm 510.5mm, clip, width=\textwidth]{simulations/Profiles_SimuPoly_Estimated}
	...
	\begin{table}[H]
		...
		\noindent\adjustbox{max width=\textwidth}{%
			\begin{tabu}{|c|c|}
				...
				Generation time (at the root) & $\tau=10$ years \\ \hline
				Exon size & $300$\\ \hline
				Number of exons & $16$\\ \hline
				Number of codon sites & $4,800$\\ \hline
				Population size (at the root) & $200$ \\ \hline
				Complexity (number of dimensions) & $3$ \\ \hline
				Discretization of the geometric Brownian process & $100$ step per branch \\ \hline
			\end{tabu}}
	...
	\begin{table}[H]
		...
		\noindent\adjustbox{max width=\textwidth}{%
			\begin{tabu}{|c|c|}
				...
				Root age & $150$ Million years \\ \hline
				Generation time (at the root) & $\tau=10$ years \\ \hline
				Protein & Protein phosphatase \citep{Goldstein2017} \\ \hline
				Exon size & $300$\\ \hline
				Number of exons & $16$\\ \hline
				Number of codon sites & $4,800$\\ \hline
				Population size (at the root) & $100,000$ \\ \hline
				Discretization of the geometric Brownian process & $100$ step per branch \\ \hline
			\end{tabu}}
		\caption[Parameters used for \texttt{SimuGeo}]{
			Parameters used for \texttt{SimuGeo}.
	...
	\input{cds.highcoverage.orthomam.list} \\
	...
	\input{orthomam.rep1.list}

	The replicate 2 is composed of :\\
	\input{orthomam.rep2.list}

	The replicate 3 is composed of :\\
	\input{orthomam.rep3.list}

	The replicate 4 is composed of :\\
	\input{orthomam.rep4.list}
	...
	\input{cds.highcoverage.isopods.list} \\

	$6$ independent inferences were performed on a randomly chosen set of $12$ coding sequences ({CDS}) out of the $135$.\\

	The replicate 1 is composed of :\\
	\input{isopods.rep1.list}\\

	The replicate 2 is composed of :\\
	\input{isopods.rep2.list} \\

	The replicate 3 is composed of :\\
	\input{isopods.rep3.list}\\

	The replicate 4 is composed of :\\
	\input{isopods.rep4.list}\\

	The replicate 5 is composed of :\\
	\input{isopods.rep5.list}\\

	The replicate 6 is composed of :\\
	\input{isopods.rep6.list}
