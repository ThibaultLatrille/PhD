...
In this model, each codon site $\site$ has its own fitness profile, denoted $\Profile\siteexp = \{ \Profile\siteexp_{\aaSource},\ 1 \leq \aaSource \leq 20 \}$, a vector of 20 amino-acid (Wrightian) fitnesses.
