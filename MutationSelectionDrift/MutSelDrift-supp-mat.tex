...
\begin{equation}
    \entropy\catexp = - \sum\limits_{\aSetAa} \base\catexp_{\aminoacid} \ln \left( \base\catexp_{\aminoacid} \right)
\end{equation}
...
Under a simulation with site-specific fitness profiles, a fitness profile give a fitness for each amino acid (vector of size $20$).
