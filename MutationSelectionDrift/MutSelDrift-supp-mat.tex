...
\begin{table}[H]
    ...
    \begin{tabu}{|c|c|c|}
        \hline
        \textbf{Experiment} & $\langle \Omega \rangle$ (\textbf{branch} $\Ne$) &  $\langle \Omega \rangle$ (\textbf{constant} $\Ne$) \\ \hline
        \hline
...
\begin{figure}[H]
    ...
    \caption[$\dnds$ estimation in mammals]{Non-synonymous \gls{substitution} rate ($\dnds$) estimation in mammals}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption[Repeatability of $\Ne$ estimation in isopods]{Repeatability of \gls{effective-population-size} ($\Ne$) estimation in isopods}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[$\dnds$ estimation in primates]{Non-synonymous \gls{substitution} rate ($\dnds$) estimation in primates}
\end{figure}
