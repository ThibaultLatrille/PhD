...
This led to a broad range of applications, either to detect proteins under adaptive selection (REFS), or to measure the modulations of the strength of purifying selection between sites (REFS), genes (REFS), or lineages (REFS).
...
Concerning $\Ne$, the slope of the linear regression between inferred and simulated $\Ne$ is ($r^2=$).
...
Additionally, our empirical framework was also applied in primates (see section~\ref{sec:empirical-data-in-primates} in supplementary materials).
...
Finally, our empirical framework was also applied in drosophila and related to genome size (see section~\ref{sec:empirical-data-in-drosophila} in supplementary materials).
