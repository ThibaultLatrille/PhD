...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.411\linewidth}
        \includegraphics[valign=t, width=\linewidth, page=1, clip, trim=0cm 0cm 15.35cm 0.45cm]{mammals/18CDS_SiteMutSelBranchNe_R1_LogPopulationSize}
    \end{minipage}
    ...
    \end{minipage}
    \begin{minipage}{0.411\linewidth}
        \reflectbox{\includegraphics[valign=t, width=\linewidth, page=1, clip, trim=0cm 5.05cm 15.35cm 0cm]{mammals/18CDS_SiteMutSelBranchNe_R1_LogMutationRatePerTime}}
