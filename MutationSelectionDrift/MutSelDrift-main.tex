...
Protein coding DNA sequences alignment and qualitative life-history traits such as habitat (surface or underground), pigmentation (depigmented, partially depigmented or pigmented) and ocular structure (anophthalmia, microphtalmia, or ocular) are available for these species~\citep{Scalier2019}.
...
Finally, our empirical framework was also applied in drosophila and primates (see~\ref{sec:empirical-data-in-primates} and~\ref{sec:empirical-data-in-drosophila} in supplementary materials).
...
Combined together, the resulting framework can reconstruct site-heterogeneous amino-acid fitness landscapes, estimates the age of internal nodes, and finally reconstitute branch-heterogeneous life-history traits, $\mu$ and $\Ne$, with their correlation.
...
% Longvariance in Ne 
If the trend is in right direction, the magnitude of the change is greatly inferior to the expected variation observed in mammals \citep{Galtier2016}.
