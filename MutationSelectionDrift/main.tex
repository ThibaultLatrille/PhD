...
% \editor{}
	...
	This assumption can be aleviated by introducing variation of $\Ne$  between lineages.
	In addition to $\Ne$, the mutation rate ($\mu$) is susceptible to vary between lineages, were both should co-vary with life-history traits ({LHT}s).
	...
	It was tested against simulated data, and finally applied to empirical data in mammals, isopods, primates.
