...
\end{equation}
The malthusian fitness (or log-fitness) of amino acid $\aminoacid$, denoted $\fit\siteexp_{\aminoacid}$, is accordingly:
\begin{equation}
    \fit\siteexp_{\aminoacid} = \ln \left( \profile\siteexp_{\aminoacid} \right),\ \Setsite, \ \SetAa
\end{equation}
...
For a site $\site$, the diversity $D\siteexp$ (or effective number of amino acids) is computed as the exponential of Shannon's entropy from the frequencies of the different amino-acids ($\Freq\siteexp = \{ \Freq\siteexp_{\aminoacid},\ \SetAa$):
\begin{equation}
