...
Conversely, a low value for $\Ner$ induces more even (i.e.~neutral) amino-acid fitness profiles at each site.
Thus, ultimately, the stringency of selection increase with $\Ner$.
Altogether, the two parameters of the model tune the mutation bias ($\lambda$) and the stringency of selection ($\Ner$), respectively, as depicted in figure~\ref{fig:mut-bias-parameters}.
...
\begin{figure}[h]
 ...
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize A\hspace{0.35cm}}}\hfill
 \begin{minipage}{0.32\linewidth}
 \includegraphics[width=\linewidth, page=1]{simulations/at_over_gc_2}
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize B\hspace{0.35cm}}}\hfill
 \begin{minipage}{0.32\linewidth}
 \includegraphics[width=\linewidth, page=1]{simulations/at_over_gc_3}
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize D\hspace{0.35cm}}}\hfill
 \begin{minipage}{0.32\linewidth}
 \includegraphics[width=\linewidth, page=1]{simulations/omega}
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize E\hspace{0.35cm}}}\hfill
 \begin{minipage}{0.32\linewidth}
 \includegraphics[width=\linewidth, page=1]{simulations/omega_WS}
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize F\hspace{0.35cm}}}\hfill
 \begin{minipage}{0.32\linewidth}
 \includegraphics[width=\linewidth, page=1]{simulations/omega_WS_over_SW}
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize C\hspace{0.35cm}}}\hfill
 ...
 Stringency of selection is represented by 4 coloured solid lines with increasing $\Ner$.
 ...
 Bottom row: Mean scaled fixation probability ($\avgpfix$) in vertical axis as a function of mutational bias ($\lambda$) in the horizontal axis, for different stringency of selection ($\Ner$) in coloured solid lines.
...
\begin{figure}[!htb]
 ...
 \end{minipage}
 \llap{\raisebox{-1.15cm}{\scriptsize C\hspace{0.55cm}}}\hfill
...
\begin{figure}[!htb]
 ...
 The estimated values of $\widehat{\omega}_{\aai, \aaj}$ are obtained by fitting the mean-field model (equation~\ref{eq:codon-mean-field}) onto the generated simulated alignment at the primate scale (61 taxa, 4980 codon sites).
...
\begin{table}[h]
 ...
 \toprule
 {} & Primates & lactamase & Hominoidea & Primates AT-rich & Primates GC-rich & Cercopithecoidea & Platyrrhini & np & Simiiformes & Catarrhini \\
 \midrule
 \textbf{Number of taxa} & 61 & 85 & 7 & 22 & 22 & 18 & 15 & 180 & 40 & 25 \\
 \textbf{Number of sites} & 5300 & 263 & 5300 & 4877 & 4811 & 5300 & 5300 & 498 & 5300 & 5300 \\
 \textbf{$\atgc$} & 1.075 & 0.792 & 1.098 & 2.028 & 0.321 & 1.096 & 1.098 & 1.154 & 1.097 & 1.097 \\
 \textbf{$\atgc$ at first coding position} & 0.996 & 0.583 & 1.008 & 1.303 & 0.309 & 1.000 & 1.009 & 1.057 & 1.005 & 1.002 \\
 \textbf{$\atgc$ at second coding position} & 1.426 & 1.177 & 1.439 & 2.541 & 0.595 & 1.440 & 1.444 & 1.221 & 1.441 & 1.440 \\
 \textbf{$\atgc$ at third coding position} & 0.878 & 0.714 & 0.916 & 2.648 & 0.136 & 0.918 & 0.913 & 1.192 & 0.916 & 0.918 \\
 % \textbf{GTR mutational bias ($\widehat{\lambda}_{\text{{GTR}}}$)} & 0.821 & 0.719 & 0.910 & 2.364 & 0.155 & 0.940 & 0.926 & 1.455 & 0.950 & 0.932 \\
 \textbf{Muse \& Gaut mutational bias ($\widehat{\lambda}_{\text{{MG}}}$)} & 1.139 & 0.853 & 1.162 & 2.073 & 0.340 & 1.177 & 1.187 & 1.447 & 1.205 & 1.178 \\
 \textbf{Mean-field mutational bias ($\widehat{\lambda}_{\text{{MF}}}$)} & 1.022 & 0.690 & 0.995 & 2.419 & 0.178 & 1.024 & 1.057 & 1.748 & 1.108 & 1.038 \\
 $\bm{\widehat{\omega}_{\text{{MG}}}}$ & 0.272 & 0.332 & 0.367 & 0.526 & 0.149 & 0.316 & 0.333 & 0.114 & 0.325 & 0.328 \\
 $\bm{\widehat{\avgpfix}_{\text{{MF}}}}$ & 0.272 & 0.336 & 0.380 & 0.525 & 0.119 & 0.318 & 0.343 & 0.116 & 0.332 & 0.334 \\
 $\bm{\widehat{\avgpfix}_{\text{{MF}},\ATtoGC}}$ & 0.254 & 0.297 & 0.325 & 0.594 & 0.071 & 0.292 & 0.302 & 0.141 & 0.303 & 0.303 \\
 $\bm{\widehat{\avgpfix}_{\text{{MF}},\GCtoAT}}$ & 0.308 & 0.412 & 0.410 & 0.487 & 0.193 & 0.363 & 0.362 & 0.092 & 0.347 & 0.369 \\
 \textbf{$\bm{\Delta}$AIC} & 1091.0 & 37.6 & 371.6 & 1527.0 & 1856.4 & 359.8 & 487.9 & 165.2 & 586.2 & 403.5 \\
 \textbf{p-value$\bm{_{\chi^2 \text{LRT}}}$} & 2.9e$^{-207}$ & 9.2e$^{-13}$ & 2.2e$^{-67}$ & 3.9e$^{-296}$ & 0 & 3.1e$^{-65}$ & 6.6e$^{-89}$ & 1.2e$^{-31}$ & 1.4e$^{-107}$ & 3.3e$^{-73}$ \\
  \bottomrule
 \end{tabu}}
 ...
 These models are applied to distinct datasets of protein-coding {DNA} alignment, in nucleoprotein in the left column and $\beta$-lactamase in the right column.
