...
\newglossaryentry{diploid}{name={diploid},description={Organism (or phase) displaying a ploidy of 2 ($n=2$), \textit{i.e.}\ two sets of chromosomes (which are paired)}}
...
\newglossaryentry{haploid}{name={haploid},description={Organism (or phase) displaying a ploidy of 1 ($n=1$), \textit{i.e.}\ a single set of chromosomes}}
