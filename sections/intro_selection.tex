...
\begin{table}[h]
	\resizebox{\columnwidth}{!}{%
		\begin{tabular}{|c|l|c|l|c|l|c|l|c|c|}
			...
			\hline
	\end{tabular}}
	\caption[The Genetic Code]{Non-polar in yellow (\textcolor{Nonpolar}{\ding{110}}). Polar in green (\textcolor{Polar}{\ding{110}}). Basic in blue (\textcolor{Basic}{\ding{110}}). Acidic in red (\textcolor{Acidic}{\ding{110}})}
...
\begin{center}
	...
	\end{minipage}
	\captionof{figure}[Graphs of codon and amino-acid transitions]{
