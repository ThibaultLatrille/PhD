...
But assumptions of the models can be broken, resulting in discrepancy between $\omega_0$ and $\omega$, modeled as a multiplying factor $\omega_*$ \cite{Rodrigue2016}:
\begin{equation}
