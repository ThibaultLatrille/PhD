...
\begin{table}[htbp]
    ...
    \begin{tabu}{|c|l|}
        ...
        \multirow{2}{*}{$\omega$} & Scaling factor for all \gls{non-synonymous} \glspl{substitution} in the \citet{Muse1994} formalism. \\
        & Also, $\avgpfix_{\text{\acrshort{MG}}}=\omega$ in the Muse \& Gaut formalism. \\ \hline
