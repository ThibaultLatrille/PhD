...
Altogether, the \acrshort{DNA} genetic code, which is used almost universally by all organisms, translates \gls{codon} to amino acids as given in table~\ref{table:genetic_code}.
...
Conversely, a default of \gls{non-synonymous} \glspl{substitution}, leading to $\omega<1$, mean the protein is globally under purifying selection.
...
In other words, because the current sequence is at mutation-selection-drift balance, there are more ways to move downward than upward in the fitness landscape.
