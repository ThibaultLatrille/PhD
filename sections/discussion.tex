...
$\bullet$ Estimating the contribution of folding stability to nonspecific epistasis in protein evolution.
...
2. Are phylogenetic \gls{codon} models and population-genetics models independently estimating the same parameters ?
