...
Broadly speaking, supporters of Mendelian genetics held that evolution was driven by mutations transmitted by the discrete segregation of \glspl{allele}, which biometricians rejected on the basis that this would necessarily imply discontinuous evolutionary leaps~\citep{bowler2003evolution}.
...
The emergence of this new scientific field was the first step towards the development of a unified theory of evolution~\citep{huxley1942evolution}, essentially defined on the basis that natural selection acts on the heritable variation supplied by mutations~\citep{mayr1959where,stebbins1966processes,dobzhansky1974chance}.
...
As the support of heredity, \acrshort{DNA} gained a central role in evolutionary biology.
...
This entails the specification of the number of loci, the effect sizes contributed by each of them, the possible dominance or epistatic interactions between \glspl{allele} at the same locus or between loci, etc.
...
First, by comparing protein sequences from related species, it was observed that the number of point \glspl{substitution} between pairs of species was approximately proportional to the time since their last common ancestor~\citep{Zuckerkandl1965,Salser1976}.
These observations led to posit the molecular clock hypothesis, which assumes that the rate at which point \glspl{substitution} accumulate is approximately constant through time.
...
Finally, by comparing \acrshort{DNA} sequences in related species, it was observed that the overall (genome-wide) rate of \acrshort{DNA} \glspl{substitution} is very high, of least one nucleotide base per genome every two years in a mammalian lineage.
...
The main tenet of the \gls{neutral} theory is that most intra- and inter-specific molecular variation is in fact adaptively \gls{neutral}, thus explaining the high protein variability observed in polymorphism datasets, where the diversity is supplied by a high mutational input.
Subsequently to origination by mutation, this selectively \gls{neutral} diversity is reduced by the random extinction of \glspl{allele}, via the cumulative effect of the random sampling of \glspl{allele} at each generation.
Although the likely fate of a \gls{neutral} \gls{allele} just created by mutation is its ultimate extinction, it is also possible that random drift leads to the fixation of this \gls{allele} in the population.
In this context, the frequency of the \gls{neutral} \gls{allele} fluctuates through generations, randomly increasing or decreasing over time, because only a relatively small number of \glspl{gamete} are randomly sampled out of the vast number of male and female \glspl{gamete} produced in each generation.
As a consequence, the effect of \gls{genetic drift} at the level of a population results into divergence between lineages, where the majority of the nucleotide \glspl{substitution} in the course of evolution must have been the result of the random fixation of \gls{neutral} mutants rather than the result of positive Darwinian selection.
Of note, the \gls{neutral} theory does not say that most mutations are \gls{neutral} or that adaptation does not take place.
...
The argument of the \gls{neutral} theory is just that most mutations that are not deleterious are essentially \gls{neutral}.
Adaptive mutations are just rare, relative to \gls{neutral} mutations, and as a consequence, adaptive arguments do not need to be invoked in order to explain most of the observed intra- and inter-specific variation.

In a second step, \citet{Ohta1971} refined the \gls{neutral} theory, by proposing that mutations can have an effect on the \gls{phenotype}, and therefore on fitness.
...
\citet{Ohta1973} later proposed a mathematical formalization of this argument, incorporating weakly selected mutations to propose the \gls{nearly-neutral} theory.
This theory emphasizes that selective effects lower than the inverse of \gls{effective population size} are negligible and are expected to behave neutrally.
In this regard, \gls{effective population size} ($\Ne$) is a quantitative measure of \gls{genetic drift} such that \gls{genetic drift} decreases with increased \gls{effective population size}.

The \gls{neutral} theory sparked a long-standing controversy between neutralist and selectionists.
...
Of note, even if the probability of fixation of any given \gls{neutral} mutation is low ($p = 1/2\Ne$), the high rate of mutation at the gene or genome-wide level and the highly degenerate mapping between genotype and \gls{phenotype} both leave considerable latitude at the molecular level for random genetic changes that have no effect upon the fitness of the organism~\citep{King1969}.
As a result, the total flux of \gls{neutral} \glspl{substitution} can in fact be the dominant contribution to intraspecific polymorphism and interspecific differences.
This overwhelming combinatorial effect was probably the point that was hard to grasp by many evolutionary biologists at the time, trained in the idea that most mutations should have an effect on the \gls{phenotype}.
Another factor that contributed to the difficulty in accepting the \gls{neutral} theory is the fact that \glspl{effective population size} turn out to be much smaller than true (census) population sizes.
This point is important, because, according to the \gls{nearly-neutral} theory of \citet{Ohta1992}, the inverse of \gls{effective population size} directly determines the proportion of all mutations that are effectively \gls{neutral}.
Once it is recognized that \glspl{effective population size} are small, it becomes easier to accept that most mutations with weak effects are effectively \gls{neutral}.

As of today, it is widely accepted that both \gls{genetic drift} and natural selection participate in the evolution of genomes.
The controversy is no longer strictly dichotomous but rather concerns the quantitative contributions of adaptive and of non-adaptive evolutionary processes, and their articulation with regards to mutation, selection, drift, migration, \gls{gene conversion}, and other evolutionary processes.


\section{The legacy of the nearly-neutral theory}
\label{sec:the-legacy-of-the-nearly-neutral-theory}

The \gls{neutral} theory, and its \gls{nearly-neutral} extension, have broad implications in evolutionary biology.
...
Questions within this framework range from the causes of mutational rate variation, to the structure of fitness landscapes, or the impact of changes in \gls{effective population size} between species.
In the following, I summarize several of the most important insights that have been contributed by the \gls{neutral} and \gls{nearly-neutral} theory, and how they still play on current research in molecular evolution.

\subsection{Mostly-purifying selection}
\label{subsec:mostly-purifying-selection}

First, along with the adoption of the \gls{nearly-neutral} theory by evolutionary biologists, the common perception about the nature of selection shifted from selection being a driver of changes mediated by adaptive mutations to a mainly purifying force discarding and filtering out strongly deleterious mutations~\citep{Lynch2007}.
...
This effect can be observed in underlying \acrshort{DNA} sequences, where \gls{non-synonymous} \glspl{substitution} occur less frequently than \gls{synonymous} substitutions~\citep{King1969}, and similarly, radical amino acid replacements are more frequent than conservative changes~\citep{kimura1983neutral}.
These effects are also observed within populations, \gls{non-synonymous} single-nucleotide polymorphisms segregate at lower frequencies compared to \gls{synonymous} polymorphisms, a phenomenon explained by purification of deleterious \glspl{allele} which cannot reach high frequencies~\citep{Akashi1999, Cargill1999, Hughes2005}.
Finally, what determines the rate of \gls{non-synonymous} evolution of protein-coding genes is primarily the amount of selective constraint acting on them, such that slowly evolving genes are just more constrained than fast-evolving genes~\citet{kimura1983neutral}.
...
This relates to another important conceptual point contributed by the \gls{nearly-neutral} theory.
...
Thus, as noted early on by \citet{King1969}, amino acids that have more \glspl{codon} are more frequently represented in natural protein coding sequences.
Similarly, later work by \citet{Singer2000} has shown that species with a mutational bias towards AT (respectively GC) tended to have proteomes with a higher frequency of amino acids encoded by AT-rich (respectively GC-rich) \glspl{codon}.
...
This trade-off between mutation and selection is regulated by the amount of random drift, and thus by \gls{effective population size}.
...
Correctly formalizing this interplay between mutation, selection and drift in the context of phylogenetic \gls{codon} models is in fact at the core of most of the work presented in the thesis.

\subsection{The importance of drift}
\label{subsec:importance-of-drift}

Tempering the effect of selection, drift mediated by \gls{effective population size} has been repeatedly invoked to explain the relaxation of the selective strength.
First, it has been observed that within populations relative diversity of selected site is more reduced for species with smaller \gls{effective population size}.
Indeed, in an intra-specific context, the \gls{non-synonymous} diversity, relative to the \gls{synonymous} diversity (i.e.~$\pnps$), is reduced in species characterized by smaller effective population sizes~\citep{Piganeau2009, Elyashiv2010, Galtier2016, Chen2017, James2017}.
Similarly, in a phylogenetic context, the strength of selection, such as measured by the relative rate of \gls{non-synonymous} over \gls{synonymous} \gls{substitution}, is lower along lineages with small effective population size~\citep{Ohta1993, Ohta1995, Moran1996, Woolfit2003, Woolfit2005, Popadin2007}.
It is important to note that, in most cases, the \gls{effective population size} is not directly measured, but a surrogate measure is used instead, for example \gls{synonymous} diversity (i.e.~$\ps$) as in ~\citep{Galtier2016}, or body size or longevity, expected to be large in lineages with a low $\Ne$~\citep{Romiguier2014}.
Leveraging the \gls{nearly-neutral} theory in order to quantitatively measure \gls{effective population size} in a phylogenetic context is one of the main objectives of this thesis, such as presented in chapter~\ref{chap:MutSelDrift}.
Of note, the quantitative response of the molecular evolutionary process to changes in \gls{effective population size} appears to strongly depend on the underlying fitness landscapes~\citep{Welch2008}, to the point of being entirely absent~\citep{Cherry1998, Goldstein2013}.
This relationship between the rate of evolution and \gls{effective population size} is also a main question addressed in this thesis, such as studied in chapter~\ref{chap:GenoPhenoFit}.
...
The fact that the \gls{neutral} theory has been relatively silent on this question has largely contributed to its rejection by many biologists, and in many respects the question is still open.
At first, methods for detecting adaptation have been developed, integrating either the \gls{neutral} or the \gls{nearly-neutral} regime as a null model.
...
\citet{kimura1983neutral} proposed a more radical insight about the link between phenotypic adaptation and \gls{neutral} molecular evolution.
By showing an example of a phenotypic trait under stabilizing selection and controlled by a large number of loci with small effects, \gls{phenotype} efficiently optimized by selection, but the molecular evolutionary process at each locus essentially indistinguishable from a \gls{neutral} process.
...
Originally, the \gls{neutral} theory was heavily relying on the molecular clock hypothesis of \citet{Zuckerkandl1965}, which posits that rate of sequence evolution is constant through time and across evolutionary lineages.
...
This rejection of the strict clock motivated important methodological developments for modelling the fluctuations of the \gls{substitution} rate along a phylogeny~\citep{Sanderson1997, Thorne1998, Kishino2001, Aris-Brosou2002, Drummond2006, Lepage2007}.
The primary motivation for these relaxed clock models was to achieve more accurate molecular dating.
However, these developments also fostered comparative analyses, trying to explain the causes of the variation of \gls{substitution} rate between lineages.
...
Empirically, generation time, but also metabolic rate, or selection for longevity, are potential explanations for the variation in \gls{substitution} rate~\citep{Lartillot2012}, which can be interpreted in the light of the molecular mechanisms of cell division~\citep{Gao2016}.

The exact reasons for the variation in \gls{substitution} rate between lineages are still debated.
However, what is clear is that this variation is mostly reflecting variation in the mutation rate.
As such, and in spite of the historically central role played by the molecular clock in the arguments in favour of the \gls{neutral} theory, the rejection of the molecular clock by empirical data does not contradict the \gls{neutral} theory.
It just confirms that, in a \gls{neutral} or \gls{nearly-neutral} regime, the molecular evolutionary process is mutation-limited, or, in other words, that the \gls{substitution} rate is determined primarily by the mutation rate.
...
Finally, some patterns have been found inconsistent within the general framework of mutation, selection and drift, thus leading to uncovering new forces such as \gls{biased gene conversion} which mimics selection but are fundamentally segregation distortion during recombination~\citep{Marais2003,Galtier2007,Duret2009}.
...
However, even though forces such as \gls{biased gene conversion} are not within the scope of this thesis, some assumptions and design of our models had been taken such as to implement these forces subsequently.
