...
In this context, the frequency of the \gls{neutral} \gls{allele} fluctuates through generations, randomly increasing or decreasing over time, because only a relatively small number of gametes are randomly sampled out of the vast number of male and female gametes produced in each generation.
...
However, those mutations are quickly purified away and are generally not visible, neither in the polymorphism within species nor in the divergence between species.
...
This effect can be observed in underlying \acrshort{DNA} sequences, where \gls{non-synonymous} \glspl{substitution} occur less frequently than \gls{synonymous} substitutions~\citep{King1969}, and similarly, radical amino acid replacements are more less than conservative changes~\citep{kimura1983neutral}.
...
Indeed, in an intra-specific context, the \gls{non-synonymous} diversity, relative to the \gls{synonymous} diversity (i.e.~$\pnps$), is reduced in species characterized by larger effective population sizes~\citep{Piganeau2009, Elyashiv2010, Galtier2016, Chen2017, James2017}.
