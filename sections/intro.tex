...
\subsection{Molecular sequences rate of evolution}

$\bullet$ The nearly-neutral theory resulted in prediction on the pace of evolution measurable in the divergence between molecular sequences in different organisms.

$\bullet$ Prediction of intra-genetic diversity is out of the scope of this manuscript, as well as estimation of the rate of adaptation.

$\bullet$ In protein coding DNA sequences, the rate of evolution of non-synonymous mutations can be normalized by the neutral rate of synonymous mutations.

$\bullet$ Estimation of the rate of evolution along clades and across branches, across genes and between different sites of orthologous genes sought to uncover the determining factor of the rate of evolution.

$\bullet$ Correlation of substitution rate with quantitative traits that are proxy of effective population size, thought with mixed results.

$\bullet$ Correlation of substitution rate with gene expression, with highly expressed genes under stronger purifying selection.

$\bullet$ Phenomenological models of evolution are qualitative, in the sens that they aggregate selection and drift through an unique parameter.

$\bullet$ Firstly, by aggregating selection and drift into a sole parameter, is the mutational process estimated reliably?

$\bullet$ How to formally quantify the rate of substitution as resulting from an process integrating mutation, selection and drift.

$\bullet$ Mecanistic models are integrative, and substitution is parameterized directly in terms of mutation, selection and drift.

$\bullet$ Theoretically, how does the rate of substitution depends on the fitness landscape?

$\bullet$ What can be inferred on the structure of the fitness landscape, variation of drift and mutational bias from empirical data?
